...
export class AirlinesListComponent implements OnInit {
  ...
  getAirlines() {
    ...
    */
      ...
      this.infyAirlinesService.getAirlines().subscribe((response)=>{
        ...
        this.airlinesArray = this.airlinesArray.map((ele)=>{
          ele.airlinesImage = "../../assets/" + ele.airlinesImage ; 
          console.log( ele.airlinesImage);
  ...
  showBookingForm(airlinesId: any) {
    ...
    this.router.navigate( ['/book-ticket/',airlinesId.id] ) ;
  }
}
