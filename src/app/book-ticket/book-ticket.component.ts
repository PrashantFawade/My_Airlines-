...
export class BookTicketComponent implements OnInit {
  ...
  constructor(private _aRoute: ActivatedRoute, private formBuilder: FormBuilder, private ias: InfyAirlinesService) { }

  public airlinesId: any = '';
  ...
  ngOnInit(): void {
    /* ADD THE CODE HERE TO FETCH THE airlinesId from ROUTE PARAMETER and set to airlinesId property*/
       this._aRoute.params.subscribe((data:any)=>{
  ...
  validateDate(c: FormControl) {
    ...
    */
    ...
    return todaysDate > selectedDate ? { dateError: { message: "Journey Date cant be a past date" } } : null ;
  }
  ...
  bookTicket() {
    ...
    */
      ...
      this.ias.bookTicket(this.bookingForm.value).subscribe((success)=>{
        this.successMessage =  "Your ticket is successfully Booked. Booking id is " + success.id ;
      } , (error)=>{
